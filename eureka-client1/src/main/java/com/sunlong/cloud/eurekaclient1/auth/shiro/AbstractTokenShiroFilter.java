 ...
 */
public abstract class AbstractTokenShiroFilter extends OncePerRequestFilter {

    private static final Logger log = LoggerFactory.getLogger(AbstractTokenShiroFilter.class);
    ...
    protected AbstractTokenShiroFilter() {
    ...
    protected TokenSecurityManager createDefaultSecurityManager() {
        return new TokenSecurityManager();
    }
...
//    }
    ...
    protected ServletRequest wrapServletRequest(HttpServletRequest orig) {
        return new ShiroHttpServletRequest(orig, getServletContext(), false);
    }
